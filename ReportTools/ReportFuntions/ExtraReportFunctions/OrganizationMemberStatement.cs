...
{
    internal class OrganizationMemberStatementReport
    {
        public static ReportDocument CrystalRerportDocument; 

        public static string ReportFileName = @"Reports\ExtraReports\OrganizationMemberStatementRpt.rpt";


        public static void OrganizationMemberStatementReportCall(string baseUrl, ReportDocument cryRpt,
            ...
            string company1, string address1, string userid, int paymode, string orgid)
        {
            ...
            //  initdate+ "&finaldate="+finaldate+"&userid="+userid+"&paymode="+paymode).Result;
                   ...
                   var response = client.GetAsync(baseUrl + "/api/ReportSection/OrganizationMemberStatementSelect?init=" + initdate.ToString() + "&final=" + finaldate.ToString()
            ...
            {
                var test = JsonConvert.DeserializeObject<List<OrganizationMemberStatement_dt>>(responseString);
        ...
        public class OrganizationMemberStatement_dt
        {
