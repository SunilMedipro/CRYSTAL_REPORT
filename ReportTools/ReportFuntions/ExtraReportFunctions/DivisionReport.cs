...
{
    internal class DivisionReport
    {
        public static ReportDocument CrystalRerportDocument;

        public static string ReportFileName = @"Reports\ExtraReports\DivisionReport.rpt";


        public static void DivisionReportCall(string baseUrl, ReportDocument cryRpt,
            ...
            string company1, string address1, string userid, int paymode,int firm)
        {
            ...
            var response = client.GetAsync(baseUrl + "api/division").Result;
            ...
            if (response.IsSuccessStatusCode == true)
            {
                ...
                var test = JsonConvert.DeserializeObject<List<Division_dt>>(responseString);
